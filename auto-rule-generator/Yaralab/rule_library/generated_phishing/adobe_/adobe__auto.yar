/*
   ...
   Date: 2026-02-27
   Identifier: adobe_
   Reference: adobe_ phishing_kit auto gen
*/

/* Rule Set ----------------------------------------------------------------- */

rule _opt_mal_adobe__home_ubuntu_malware_lab_samples_extracted_phishing_Adobe_index {
   meta:
      description = "adobe_ - file index.php"
      author = "Comps Team Malware Lab"
      reference = "adobe_ phishing_kit auto gen"
      date = "2026-02-27"
...
rule _opt_mal_adobe__home_ubuntu_malware_lab_samples_extracted_phishing_Adobe_login {
   meta:
      description = "adobe_ - file login.php"
      author = "Comps Team Malware Lab"
      reference = "adobe_ phishing_kit auto gen"
      date = "2026-02-27"
...
rule _opt_mal_adobe__home_ubuntu_malware_lab_samples_extracted_phishing_Adobe_login_2 {
   meta:
      description = "adobe_ - file login.html"
      author = "Comps Team Malware Lab"
      reference = "adobe_ phishing_kit auto gen"
      date = "2026-02-27"
   ...
   strings:
      ...
      $x2 = "        <a id=\"enterprise_back_to_adobeid\" data-component=\"spinner viewswitcher\" data-component-viewswitcher-targettitle=\"S" ascii /* score: '32.00'*/
      $x3 = "                    <a id=\"enterprise_signin_link\" data-component=\"spinner viewswitcher\" data-component-viewswitcher-targett" ascii /* score: '32.00'*/
      ...
      $s6 = "3A%2F%2Fims-na1.adobelogin.com%2Fims%2Fadobeid%2FSunbreakWebUI1%2FAdobeID%2Ftoken%3Fredirect_uri%3Dhttps%253A%252F%252Faccounts." ascii /* score: '28.00'*/
      $s7 = "            <script src=\"https://static.adobelogin.com/renga-idprovider/resources/60550808d7d722ea186a935459f7234f/spectrum/scr" ascii /* score: '28.00'*/
      $s8 = "    <script src=\"https://static.adobelogin.com/renga-idprovider/resources/60550808d7d722ea186a935459f7234f/spectrum/script/spec" ascii /* score: '28.00'*/
      $s9 = "    <script src=\"https://static.adobelogin.com/renga-idprovider/resources/60550808d7d722ea186a935459f7234f/spectrum/script/spec" ascii /* score: '28.00'*/
      $s10 = "ack=https%3A%2F%2Fims-na1.adobelogin.com%2Fims%2Fadobeid%2FSunbreakWebUI1%2FAdobeID%2Ftoken%3Fredirect_uri%3Dhttps%253A%252F%252" ascii /* score: '28.00'*/
      $s11 = "        <script src=\"https://static.adobelogin.com/renga-idprovider/resources/60550808d7d722ea186a935459f7234f/spectrum/script/" ascii /* score: '28.00'*/
      $s12 = "lback=https%3A%2F%2Fims-na1.adobelogin.com%2Fims%2Fdenied%2FSunbreakWebUI1%3Fredirect_uri%3Dhttps%253A%252F%252Faccounts.adobe.c" ascii /* score: '28.00'*/
      ...
      $s14 = "            <script src=\"https://static.adobelogin.com/renga-idprovider/resources/60550808d7d722ea186a935459f7234f/spectrum/scr" ascii /* score: '28.00'*/
      ...
      $s18 = "denied_callback=https%3A%2F%2Fims-na1.adobelogin.com%2Fims%2Fdenied%2FSunbreakWebUI1%3Fredirect_uri%3Dhttps%253A%252F%252Faccoun" ascii /* score: '24.00'*/
      $s19 = "=\"login?idp_flow_type=login&amp;client_id=SunbreakWebUI1&amp;callback=https%3A%2F%2Fims-na1.adobelogin.com%2Fims%2Fadobeid%2FSu" ascii /* score: '24.00'*/
      $s20 = ".link%252Cunlink_social_account%252Cadmin_slo%252Creauthenticated&amp;denied_callback=https%3A%2F%2Fims-na1.adobelogin.com%2Fims" ascii /* score: '24.00'*/
   condition:
      uint16(0) == 0x213c and filesize < 100KB and
      1 of ($x*) and 4 of them
}

rule _opt_mal_adobe__home_ubuntu_malware_lab_samples_extracted_phishing_Adobe_ip {
   meta:
      description = "adobe_ - file ip.php"
      author = "Comps Team Malware Lab"
      reference = "adobe_ phishing_kit auto gen"
      date = "2026-02-27"
