...
This folder contains a full pipeline that does exactly this order:
...
5. Iterate rule updates using eval + yaraQA feedback
6. Produce final improved rules and final metrics
...
- `iterations/`: per-iteration rules, eval, yaraQA, and change logs
- `final-results/`: final improved rules and final summaries
